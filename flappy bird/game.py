...
# load images
bg = pygame.image.load('flappy bird/assests/bg.png')
ground_img = pygame.image.load('flappy bird/assests/ground.png')
play_button_img = pygame.image.load('flappy bird/assests/play.png')  # New play button image
game_over_img = pygame.image.load('flappy bird/assests/gameover.png')
message_img = pygame.image.load('flappy bird/assests/message.png')  # Game over image
scoreboard_img = pygame.image.load('flappy bird/assests/scoreboard.png')  # Scoreboard image
...
number_images = []
for num in range(10):
    img = pygame.image.load(f'flappy bird/assests/{num}.png')  # Ensure images are named '0.png', '1.png', ..., '9.png'
...
class Bird(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        for num in range(1, 4):
            img = pygame.image.load(f'flappy bird/assests/bird{num}.png')
...
class Pipe(pygame.sprite.Sprite):
    def __init__(self, x, y, position):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.image.load('flappy bird/assests/pipe.png')
        self.rect = self.image.get_rect()
        if position == 1:
